        ...
        /* Bloque adicional según tabla proporcionada */
        // Modalidades LU a VI
        Modalidad::create([
            'modalidad' => 'Hora (LU a VI)',
            'inversion' => 50,
            'descripcion' => 'Sesión de una hora de lunes a viernes.',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            'modalidad' => 'Semanal (LU a VI)',
            'inversion' => 260,
            'descripcion' => 'Programa semanal de lunes a viernes (7.5 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            'modalidad' => 'Quincena (LU a VI)',
            'inversion' => 420,
            'descripcion' => 'Quincenal de lunes a viernes (15 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            'modalidad' => 'Mes (LU a VI)',
            'inversion' => 650,
            'descripcion' => 'Mensual de lunes a viernes (30 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            'modalidad' => '2 Meses (LU a VI)',
            'inversion' => 1150,
            'descripcion' => 'Bimestral de lunes a viernes (60 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            'modalidad' => '3 Meses (LU a VI)',
            'inversion' => 1620,
            'descripcion' => 'Trimestral de lunes a viernes (90 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);

        // Modalidades 3 veces por semana
        Modalidad::create([
            'modalidad' => 'Semanal 3 Veces',
            'inversion' => 200,
            'descripcion' => '3 clases por semana (5 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            ...
            'inversion' => 300,
            'descripcion' => '3 clases por semana durante dos semanas (10 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            ...
            'inversion' => 450,
            'descripcion' => '3 clases por semana durante un mes (20 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            ...
            'inversion' => 800,
            'descripcion' => '3 clases por semana durante dos meses (40 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);
        Modalidad::create([
            ...
            'inversion' => 1140,
            'descripcion' => '3 clases por semana durante tres meses (60 h).',
            'estado' => 1,
            'product_id' => 1,
        ]);