...
class ModalidadSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Modalidad::create([
            ...
            'inversion' => 185,
            'descripcion' => 'Clases 3 veces por semana con carga horaria de 5 horas.',
            'estado' => 1,
            'product_id' => 1, // Apoyo escolar Inicial
        ]);
        ...
        Modalidad::create([
            ...
            'inversion' => 265,
            'descripcion' => 'Refuerzo académico durante dos semanas tres veces por semana consecutivas con 10 horas de carga horaria efectiva.',
            'estado' => 1,
            'product_id' => 1, // Apoyo escolar Inicial
        ]);
